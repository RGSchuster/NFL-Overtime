...
for year in range(1974,2018): #OT was added in 1974.
    ...
    if year <= 1977:
        ...
        weekCount = [i for i in range(1,19)] #18 week season was tested
    elif year <= 1989:
    ...
    for week in weekCount:
        ...
        for eachGame in soup.find_all('table', class_='teams'):
            ...
            if week == 1 or week==2 or week==3:
                #Builds a dictionary of all team names. Rebuilt every year because teams are added and removed occasionally
                #Checks multiple weeks because of oddities in the NFL schedule (eg. week 1 bye weeks, postponed games)
